    ...
    <form action="{{route('branchOffices.update', [$office->user_id, $office->id])}}" method="post">
        ...
        <div class="card-body d-flex flex-row flex-wrap">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control form-control-solid" placeholder="Numero de documento" name="branch_office_document_number" value="{{$office->document_number}}" />
                <span class="form-text text-muted"></span>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control form-control-solid" placeholder="Telefono" name="branch_office_phone" value="{{$office->phone}}" />
                <span class="form-text text-muted"></span>
            </div>
            <div class="form-group col-md-4">
