<!-- Modal Create-->
<div class="modal fade" id="createRolModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <form action="{{route('roles.store')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 d-flex justify-content-start align-items-center mt-3">
        ...
        <div class="modal-body">
            <form method="post" id="formUpdateRole">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <label for=""> Nombre <span class="text-danger">*</span></label>
                        <input type="text" name="name" id="name_edit" class="form-control form-control-solid" placeholder="Usuario">
                    </div>
                    <div class="col-md-4 d-flex justify-content-start align-items-center mt-3">
                        <button class="btn"><i class="fad fa-save text-primary" style="font-size:2.3rem"></i></button>
                    </div>
