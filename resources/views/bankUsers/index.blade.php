                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-around aling-items-center flex-wrap flex-row">
                                        ...
                                        <a href="{{route('bankUsers.show', [$user->parent_id, $user->id])}}" class="btn btn-icon btn-light-primary btn-sm mr-2"  data-tooltip title="Detalle">
                                            <i class="fad fa-folder-open"></i>
                                        </a>
                                        <a href="{{route('bankUsers.edit', [$user->parent_id, $user->id])}}" class="btn btn-icon btn-light-success btn-sm mr-2"  data-tooltip title="Editar">
                                            <i class="fad fa-edit"></i>
                                        </a>
                                        {{-- <form action="{{route('customers.destroy', $bank->id)}}" method="{{'post'}}">
                                            @csrf @method('DELETE') --}}
                                            <button type="button" onclick="deleteResource('/usuario-banco/'+{{$user->parent_id}}+'/'+{{$user->id}})" class="btn btn-icon btn-light-danger btn-sm mr-2"  data-tooltip title="Eliminar">
