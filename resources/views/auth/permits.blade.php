        ...
        <table class="table table__contenedor">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span class="badge badge-success text-uppercase">Activo</span>
              </td>
            ...
            <tr>
              <td class="text-uppercase">Operador</td>
              <td>
                <span class="badge badge-success text-uppercase">Activo</span>
              </td>
              <td class="text-center">
            ...
            <tr>
              <td class="text-uppercase">Mensajero</td>
              <td>
                <span class="badge badge-success text-uppercase">Activo</span>
              </td>
              <td class="text-center">
            ...
            <tr>
              <td class="text-uppercase">Cliente</td>
              <td>
                <span class="badge badge-success text-uppercase">Activo</span>
              </td>
              <td class="text-center">
