    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h2 class="card-label h1">Notificaciones
                </h2>
            </div>
        ...
        <div class="card-body">
            <div id="collapseExample" class="col-md-7 mx-auto mt-4 collapse mb-4" style=""><input type="text"
                    placeholder="¿Qué desea filtrar?" class="form-control"></div>
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>Titulo Notificacion</th>
                        <td>123456789</td>
                        <td>coroncoro@gmail.com</td>
                        <td>30257777</td>
                        <td>Envío</td>
                        <td>
