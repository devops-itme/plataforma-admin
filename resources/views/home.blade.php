...
<div class="container">
    <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-custom bg-light-success gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">$5,209</span>
                            <span class="font-weight-bold text-white font-size-sm">SAP UI Progress</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 25-->
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-custom bg-light-blue-v3 card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">23,508</span>
        ...
        <div class="col-lg-8">
            <div id="records-processed" class="chart-wrapper">
            </div>
        </div>
    </div>
</div>
