    ...
    <div style="overflow-y: auto;height: 425px;">
        <table class="table table-sm table-hover">
            ...
            <tbody class="text-center max-h-425px">
                <tr v-for="(order, index) in data" :key="data.id" :class="[{'active_row': index === activeIndex}, {'urgent_row': order.urgent_dispatch === 1  && index != activeIndex}]" @click="rowClick(order,index)">
