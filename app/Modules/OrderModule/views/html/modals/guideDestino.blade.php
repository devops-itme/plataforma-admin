        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select name="rate" class="form-control form-control-solid" id="rate" disabled>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input name="value" id="value" type="number" class="form-control form-control-solid" disabled disabled
                         />
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea name="description" id="description" cols="10" disabled rows="2"
