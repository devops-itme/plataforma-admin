    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <button type="button" class="btn btn-success mr-2 px-6 font-weight-bolder" data-tooltip title="IMPORTAR"
                    data-toggle="modal" data-target="#importBatchModal">
                    <span class="svg-icon svg-icon-md">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($order->order_type == 35 && $order->status_matrix_id == 1)
                                        <button type="button" id="porDespacharOndemand" value="{{ $order->id }}"
                                            class="btn btn-icon btn-light-info btn-sm mr-2" data-tooltip
                                            title="Enviar a por despachar">
                                            <i class="fad fa-hand-holding-box"></i>
                                        </button>
                                    @endif
                                    @if ($order->order_type == 36 && $order->status_matrix_id == 1)
                                        <button type="button" id="porDespacharPackaging" value="{{ $order->id }}"
                                            class="btn btn-icon btn-light-info btn-sm mr-2" data-tooltip
                                            title="Enviar a por despachar">
                                            <i class="fad fa-hand-holding-box"></i>
                                        </button>
