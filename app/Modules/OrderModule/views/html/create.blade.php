        ...
        <div class="card-body d-flex flex-row flex-wrap pt-2">
            ...
            <div class="col-md-6">
                <div class="d-flex flex-row flex-wrap">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input name="expenses" type="number" class="form-control form-control-solid" placeholder="0.00" disabled />
                        <span class="form-text text-muted"></span>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Recibir por COD: </label>
                        <input name="receive_by_COD" type="number" class="form-control form-control-solid" placeholder="0.00" disabled />
                        <span class="form-text text-muted"></span>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Gastos diligencia: </label>
                        <input name="diligence_expenses" type="number" class="form-control form-control-solid" placeholder="0.00" disabled />
                        <span class="form-text text-muted"></span>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Producto interno: </label>
                        <input name="internal_product" type="number" class="form-control form-control-solid" placeholder="0.00" disabled />
                        <span class="form-text text-muted"></span>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Total Tax: </label>
                        <input type="hidden" value="{{$tax_percentage}}" id="tax_percentage">
                        <input name="tax_total" id="tax_total" type="number" class="form-control form-control-solid" placeholder="0.00" disabled />
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <ul class="nav nav-light-success nav-pills border-bottom pb-3" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Pedidos / Destinos</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                        @include('OrderModule.views.html.generalTab')
                    </div>
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        @include('OrderModule.views.html.guideTab')
                    </div>
                </div>
            </div>
        </div>
