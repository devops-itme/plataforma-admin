        ...
        <div class="card-body d-flex flex-row flex-wrap pt-2">
            ...
            <div class="form-group col-md-3">
                ...
                <select name="vehicle_type_id" class="form-control form-control-solid" id="vehicle_type_id">
                    ...
                    <option value="{{ $item->id }}" {{ $order->vehicle_type_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                    </option>
                    @endforeach
                </select>
            </div>
    ...
    <form id="guide_form" class="guide_form">
        ...
        <div class="card-body d-flex flex-row flex-wrap pt-2">
            ...
            <div class="form-group col-md-3">
                ...
                <input name="email_contact" id="email_contact" type="email" class="form-control form-control-solid" placeholder="" />
                <span class="form-text text-muted"></span>
            </div>
