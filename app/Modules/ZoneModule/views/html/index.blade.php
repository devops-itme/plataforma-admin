                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="form-group py-3 m-0 col-md-3">
                                    ...
                                    <select class="form-control form-control-solid" id="country" name="country_id">
                                        ...
                                        <option value="{{ $country->id }}" {{ request()->country_id != '' && request()->country_id == $country->id ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class=" row form-group py-6 m-0 col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('zones.index') }}" class="btn btn-light-danger px-6 font-weight-bold btn-block">Limpiar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <tr id="zone-id-{{ $zone->id }}">
                            ...
                            <td>
                                <div class="d-flex justify-content-around aling-items-center flex-wrap flex-row">
                                    ...
                                    <button id="{{ $zone->id }}" class="edit-btn btn btn-icon btn-light-success btn-sm mr-2" data-tooltip title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <a onclick="deleteResource('/zonas/'+{{ $zone->id }}+'?response_format=json',false,'zone-id-'+{{ $zone->id }})" class="btn btn-icon btn-light-danger btn-sm mr-2" data-tooltip title="Eliminar">
